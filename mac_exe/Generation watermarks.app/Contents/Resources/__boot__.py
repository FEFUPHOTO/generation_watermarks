...
_recipes_pil_prescript(
    ['TgaImagePlugin', 'GbrImagePlugin', 'BmpImagePlugin', 'FitsImagePlugin', 'IcoImagePlugin', 'EpsImagePlugin',
     'DdsImagePlugin', 'IcnsImagePlugin', 'PcdImagePlugin', 'GifImagePlugin', 'BlpImagePlugin', 'TiffImagePlugin',
     'FliImagePlugin', 'DcxImagePlugin', 'WebPImagePlugin', 'XpmImagePlugin', 'XVThumbImagePlugin', 'IptcImagePlugin',
     'PixarImagePlugin', 'MpegImagePlugin', 'PngImagePlugin', 'Jpeg2KImagePlugin', 'PalmImagePlugin', 'ImtImagePlugin',
     'SpiderImagePlugin', 'PsdImagePlugin', 'FpxImagePlugin', 'PpmImagePlugin', 'CurImagePlugin', 'MspImagePlugin',
     'MicImagePlugin', 'McIdasImagePlugin', 'SunImagePlugin', 'BufrStubImagePlugin', 'MpoImagePlugin',
     'Hdf5StubImagePlugin', 'PdfImagePlugin', 'PcxImagePlugin', 'FtexImagePlugin', 'JpegImagePlugin',
     'GribStubImagePlugin', 'ImImagePlugin', 'XbmImagePlugin', 'FitsStubImagePlugin', 'SgiImagePlugin',
     'WmfImagePlugin'])
